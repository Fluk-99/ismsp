...
const API_URL = 'https://ismsp-backend.onrender.com/api/settings/information-classification'
        ...
        classifications.map(cls => (
          <Box key={cls.id} sx={{ display: 'flex', gap: '10px', marginBottom: '20px', alignItems: 'center' }}>
            <TextField
              ...
              onChange={e =>
                setClassifications(prev => prev.map(c => (c.id === cls.id ? { ...c, label: e.target.value } : c)))
              }
            />
            ...
            <TextField
              ...
              disabled={!cls.isEditable}
              onChange={e =>
                setClassifications(prev => prev.map(c => (c.id === cls.id ? { ...c, description: e.target.value } : c)))
              }
            />
