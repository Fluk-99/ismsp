  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: '1.6' }}>
      ...
      >
        ...
        <p style={{ fontSize: '1.2rem', marginTop: '10px' }}>Simplify ISO 27001:2022 Compliance with Confidence</p>
        <button
          style={{
            background: '#fff',
            color: '#1e88e5',
      ...
      <section style={{ padding: '40px 20px', textAlign: 'center' }}>
        ...
        <p>
          The ISMS Platform is your trusted solution to assess and verify compliance with ISO 27001:2022 standards.
          Upload your company’s information, and let our experts handle the rest.
        </p>
      </section>
      ...
      <section style={{ padding: '40px 20px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '0 1 300px', textAlign: 'center', margin: '20px' }}>
      ...
      <section style={{ backgroundColor: 'primary', padding: '40px 20px' }}>
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          >
            The ISMS Platform made our ISO 27001 journey seamless and stress-free. Highly recommend it! - Jane Doe, CTO
            of SecureTech
          </blockquote>
        </div>
      </section>
